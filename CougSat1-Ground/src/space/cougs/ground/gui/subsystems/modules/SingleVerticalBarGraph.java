...
public class SingleVerticalBarGraph extends JComponent implements UIScaling {
  ...
  public SingleVerticalBarGraph(String label, int min, int max, int value,
      double barWidth, boolean printMinMax, double warningHigh,
  ...
  public void paintComponent(Graphics g) {
    ...
    int x =
        Math.max((barWidth - fontMetrics.stringWidth(label)) / 2, 0) + rectX;

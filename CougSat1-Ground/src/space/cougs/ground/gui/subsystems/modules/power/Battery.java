...
public class Battery extends JComponent implements UIScaling {

	private static final long serialVersionUID = 1L;
	private String varName = "";
	private double varCurrent = 0.0;
	private double varVoltage = 0.0;
	private double varPower = 0.0;
	...
	public void paintComponent(Graphics g) {
		...
		g2d.setColor(CustomColors.BACKGROUND1);
		...
		String printValues = String.format("%.3f", varVoltage) + "V " + String.format("%.1f", varPower) + "Wh";
